...
image_train, image_test, label_train, label_test = train_test_split(images, labels, test_size = 0.20, random_state = 0)
np.save('data_set_fer2013.npy', image_train)
np.save('data_labels_fer2013.npy', image_train)
np.save('test_set_fer2013.npy', image_train)
np.save('test_labels_fer2013.npy', image_train)
np.save('data_kike.npy', labels)
